...
window.LP = {
 ...
 "faq": [
  ...
  },
  {
   ...
   "a": "Да, работаем по всей Казахстану: керамику везём в жёстком каркасе, монтаж выполняет наша команда. Если у вас свой печник — приложим раскладку и инструкцию и проконсультируем его по телефону."
  },
  {
