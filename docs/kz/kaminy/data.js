/* Контент раздела «Камины» для ceramicadecor.kz. Правится в build.py — вёрстка и логика общие. */
window.LP = {
 "slug": "kaminy",
 "title": "Камины",
 "brand": {
 ...
 "faq": [
  {
   ...
   "a": "Облицовка начинается от 2 000 000 ₸, комплект под ключ с топкой и монтажом — от 6 500 000 ₸. Разброс большой, потому что художественная роспись почти вдвое дороже однотонной глазури. Посчитайте свою конфигурацию в калькуляторе выше."
  },
  {
  ...
  },
  {
   ...
   "a": "Да, работаем по всей Казахстану: доставка в жёстком каркасе, монтаж выполняет наша команда. Если монтирует ваш печник — консультируем его по телефону на каждом этапе."
  }
 ],
 "gallery": [
  "kaminy/img/01.webp",
