...
(function () {
  ...
  (function productCard() {
    ...
    /* Ссылка на конкретный объект: /izraztsovye-kaminy.html#kamin-albion
       открывает карточку сразу (Альфида, 23.09.2026). Каталог рендерится
       после загрузки, поэтому ждём его. */
