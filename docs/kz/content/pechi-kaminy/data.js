...
window.LP = {
  ...
  "fields": [
   {
    ...
    "options": [
     ...
     },
     {
      "id": "flora",
      "label": "Флора",
      "hint": "Большое стекло 4:3, до 200 м³, 4 100 000 ₸",
      "add": 4100000,
      "card": 6
     }
    ]
 ...
 "catalog": [
  {
   ...
   "collection": "Дорф",
   "desc": "Заводская модель на топке Астов 4162: обогрев до 125 м³, дымоход 150 мм. Облицовка изразцами Дорф в цвете белый антик. Комплект со склада, монтаж под ключ.",
   "spec": {
    "width": 730,
    "height": 1100,
    "depth": 575,
  ...
  },
  {
   ...
   "collection": "Дорф",
   "desc": "Заводская модель на топке Астов 4162: обогрев до 125 м³, дымоход 150 мм. Облицовка изразцами Дорф в цвете горький шоколад. Комплект со склада, монтаж под ключ.",
   "spec": {
    "width": 730,
    "height": 1100,
    "depth": 575,
  ...
  },
  {
   ...
   "collection": "Дорф",
   "desc": "Заводская модель на топке Астов 4162: обогрев до 125 м³, дымоход 150 мм. Облицовка изразцами Дорф в цвете муравленый. Комплект со склада, монтаж под ключ.",
   "spec": {
    "width": 730,
    "height": 1100,
    "depth": 575,
  ...
  },
  {
   ...
   "collection": "Ритм",
   "desc": "Заводская модель на топке Астов 4162: обогрев до 125 м³, дымоход 150 мм. Облицовка изразцами Ритм в цвете белый антик. Комплект со склада, монтаж под ключ.",
   "spec": {
    "width": 727,
    "height": 1248,
    "depth": 571,
  ...
  },
  {
   ...
   "collection": "Ритм",
   "desc": "Заводская модель на топке Астов 4162: обогрев до 125 м³, дымоход 150 мм. Облицовка изразцами Ритм в цвете бургундия. Комплект со склада, монтаж под ключ.",
   "spec": {
    "width": 727,
    "height": 1248,
    "depth": 571,
  ...
  },
  {
   ...
   "collection": "Ритм",
   "desc": "Заводская модель на топке Астов 4162: обогрев до 125 м³, дымоход 150 мм. Облицовка изразцами Ритм в цвете лазурный. Комплект со склада, монтаж под ключ.",
   "spec": {
    "width": 727,
    "height": 1248,
    "depth": 571,
 ...
 "why": {
  ...
  "bad": [
   "Проектирование и согласование обычно занимают 2–3 недели ещё до начала работ.",
  ...
  "good": [
   ...
   "Цена известна заранее: 2 850 000 ₸ за Дорф, 2 950 000 ₸ за Ритм, 4 100 000 ₸ за Флору, обвязка по прайсу.",
 ...
 "faq": [
  ...
  },
  {
   ...
   "a": "Печь-камин Дорф — 2 850 000 ₸, Ритм — 2 950 000 ₸, Флора — 4 100 000 ₸. Другой оттенок глазури из палитры — плюс 325 000 ₸. Дымоход, монтаж и доставку считаем отдельно под ваш адрес — пришлём точную смету."
  },
  {
