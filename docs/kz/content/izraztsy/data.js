...
window.LP = {
 ...
 "faq": [
  ...
  },
  {
   ...
   "a": "И то, и другое. Монтируем сами по всему Казахстану. Если у вас свой мастер — отгрузим комплект с раскладкой и инструкцией и проконсультируем его по телефону. Плитку такой цены лучше не отдавать случайной бригаде — попросите нас проверить мастера."
  },
  {
  ...
  },
  {
   ...
   "a": "Да, по всему Казахстану. Упаковываем в жёсткий каркас, груз страхуется. Стоимость доставки зависит от объёма и города — назовём при расчёте."
  }
 ],
 "gallery": [
