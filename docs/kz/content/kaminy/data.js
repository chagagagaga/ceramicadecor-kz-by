...
window.LP = {
 ...
 "faq": [
  ...
  },
  {
   ...
   "a": "Да, работаем по всему Казахстану: доставка в жёстком каркасе, монтаж выполняет наша команда. Если монтирует ваш печник — консультируем его по телефону на каждом этапе."
  }
 ],
 "gallery": [
  "content/kaminy/img/01.webp",
